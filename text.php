...
$textbotlang['users']['extend']['invoicExtend-agent'] = "🧾 فاکتور تمدید شما برای نام کاربری %s ایجاد شد.
            
🛍 نام محصول :  %s
💰 قیمت اصلی :  %s تومان
🎁 تخفیف نمایندگی : %s درصد
...
📊 حجم سرویس: %s گیگابایت
👤 موجودی شما: %s تومان";
$textbotlang['users']['buy']['invoicebuy-agent'] = "📱 پیش فاکتور شما:
👤 نام کاربری: %s
📡 نام سرویس: %s
⏰ مدت زمان: %s روز
💰 قیمت اصلی: %s تومان
...
$textbotlang['users']['Balance']['priceinput'] = "💸 مبلغ مورد نظر خود را به تومان وارد کنید:
⚠️ حداقل مبلغ شارژ: 5,000 تومان
⚠️ حداکثر مبلغ شارژ: 10,000,000 تومان";
$textbotlang['users']['Balance']['errorprice'] = "❌ مبلغ وارد شده نامعتبر است. لطفا عدد وارد کنید";
$textbotlang['users']['Balance']['errorpricelimit'] = "❌ حداقل مبلغ شارژ 5 هزار تومان و حداکثر مبلغ شارژ 10 میلیون تومان می باشد";
$textbotlang['users']['Balance']['confirm_charge_amount'] = "آیا از شارژ حساب خود به مقدار %s تومان اطمینان دارید؟";
$textbotlang['users']['Balance']['zarinpal'] = "❌ حداقل مبلغ پرداخت درگاه زرین پال ۵ هزار تومان است";
$textbotlang['users']['Balance']['linkpayments'] = "درحال ساخت لینک پرداخت...";
$textbotlang['users']['Balance']['payments'] = "💰 پرداخت آنلاین";
$textbotlang['users']['Balance']['changeto'] = "❌ برای پرداخت باید مبلغ بیشتر از ۸ هزار تومان را انتخاب کنید.";
$textbotlang['users']['Balance']['Confirmpaying'] = "✅ تایید پرداخت";
$textbotlang['users']['Balance']['errorLinkPayment'] = "❌ خطا در ساخت درگاه پرداخت ";
...
$textbotlang['users']['Balance']['Send-receipt-help'] = "🧾 لطفا تصویر فیش واریزی خود را ارسال کنید.

✅ توجه داشته باشید که تصویر باید واضح و خوانا باشد.
✅ اطلاعات مهم مانند مبلغ، تاریخ و زمان پرداخت، و شماره پیگیری باید در تصویر مشخص باشد.
✅ پس از بررسی توسط ادمین، موجودی شما افزایش خواهد یافت.";
...
2- به هیچ وجه امکان بازگشت وجه نیست پس به مبلغ پرداختی دقت کنید
3- به خاطر محدودیت تراکنش با اپلیکیشن آپ از همراه بانک، هفت هشتاد، بله و یا از خود پرداز جهت انتقال وجه استفاده فرمایید";
...
//-----------------------------[ Agency ]-------------------------------
$textbotlang['users']['agency']['request_button'] = "🤝 درخواست نمایندگی";
$textbotlang['users']['agency']['already_agency'] = "👨‍💼 شما در حال حاضر نماینده ما هستید و میتوانید از تخفیف %s درصدی خود برای تمامی محصولات استفاده کنید.";
$textbotlang['users']['agency']['pending'] = "📝 درخواست نمایندگی شما ثبت شده و در انتظار بررسی توسط مدیریت است. به محض تایید به شما اطلاع داده خواهد شد.";
$textbotlang['users']['agency']['rejected'] = "❌ متاسفانه درخواست نمایندگی شما رد شده است.";
$textbotlang['users']['agency']['request_msg'] = "🙏 شما در حال ارسال درخواست نمایندگی هستید. در صورت تایید، می‌توانید از تخفیف‌های ویژه بهره‌مند شوید. لطفاً کمی توضیح دهید که چرا می‌خواهید نماینده شوید؟";
$textbotlang['users']['agency']['request_sent'] = "✅ درخواست نمایندگی شما با موفقیت ثبت شد و به زودی توسط مدیریت بررسی خواهد شد.";
$textbotlang['users']['agency']['approved'] = "🎉 تبریک! درخواست نمایندگی شما تایید شد. شما اکنون می‌توانید از %s درصد تخفیف در تمامی محصولات استفاده کنید.";

$textbotlang['Admin']['agency']['new_request'] = "📝 درخواست نمایندگی جدید:\n\nاز طرف: %s\nنام کاربری: %s\nشناسه کاربر: %s\n\nتوضیحات: %s";
$textbotlang['Admin']['agency']['approve_btn'] = "✅ تایید";
$textbotlang['Admin']['agency']['reject_btn'] = "❌ رد";
$textbotlang['Admin']['agency']['set_discount'] = "لطفا درصد تخفیف برای این نماینده را وارد کنید (فقط عدد وارد کنید، مثلا: 40):";
$textbotlang['Admin']['agency']['discount_set'] = "✅ درصد تخفیف نماینده به %s درصد تنظیم شد.";
$textbotlang['Admin']['agency']['approved'] = "✅ درخواست نمایندگی با موفقیت تایید شد و کاربر به عنوان نماینده با %s درصد تخفیف ثبت شد.";
$textbotlang['Admin']['agency']['rejected'] = "❌ درخواست نمایندگی رد شد و به کاربر اطلاع داده شد.";
$textbotlang['Admin']['agency']['list_button'] = "👨‍💼 مدیریت نمایندگان";
$textbotlang['Admin']['agency']['no_agencies'] = "⚠️ هیچ نماینده‌ای ثبت نشده است.";
$textbotlang['Admin']['agency']['list_title'] = "📋 لیست نمایندگان:";
$textbotlang['Admin']['agency']['list_item'] = "👤 نام کاربری: %s\n🆔 شناسه: %s\n💰 درآمد: %s تومان\n💹 درصد تخفیف: %s%%\n\n";
$textbotlang['Admin']['agency']['edit_discount'] = "✏️ ویرایش درصد تخفیف";
$textbotlang['Admin']['agency']['change_discount'] = "لطفا درصد تخفیف جدید را برای نماینده %s وارد کنید:";
$textbotlang['Admin']['agency']['discount_changed'] = "✅ درصد تخفیف نماینده %s به %s درصد تغییر یافت.";
$textbotlang['Admin']['agency']['remove_btn'] = "❌ حذف نماینده";
$textbotlang['Admin']['agency']['remove_confirm'] = "آیا از حذف نماینده %s اطمینان دارید؟";
$textbotlang['Admin']['agency']['removed'] = "✅ نماینده %s با موفقیت حذف شد.";
$textbotlang['Admin']['agency']['pending_requests'] = "📝 درخواست‌های در انتظار";
$textbotlang['Admin']['agency']['no_pending'] = "⚠️ هیچ درخواست در انتظاری وجود ندارد.";

$textbotlang['users']['buy']['selectyourservice'] = "🛍 نام محصول: %s
💰 قیمت محصول: %s تومان
⏰ مدت زمان سرویس: %s
📊 حجم سرویس: %s
👤 موجودی شما: %s تومان";

$textbotlang['users']['buy']['selectyourservice-agent'] = "🛍 نام محصول: %s
💰 قیمت اصلی: %s تومان
🎁 قیمت با %s%% تخفیف نمایندگی: %s تومان
⏰ مدت زمان سرویس: %s
📊 حجم سرویس: %s
👤 موجودی شما: %s تومان";

$textbotlang['users']['Balance']['Back-Balance'] = "🔙 بازگشت";
$textbotlang['users']['Balance']['Payment-Method'] = "💳 لطفا روش پرداخت خود را از گزینه‌های زیر انتخاب کنید:";
$textbotlang['users']['Balance']['confirm_charge_amount'] = "آیا از شارژ حساب خود به مقدار %s تومان اطمینان دارید؟";